...
namespace JasperGreenTeam02.Migrations
{
    ...
    [Migration("20221109174230_initial")]
            ...
            modelBuilder.Entity("JasperGreenTeam02.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(1939),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2693),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2728),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2733),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2738),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2742),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2747),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2751),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2824),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2829),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2833),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2838),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2842),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2845),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 9, 11, 42, 29, 580, DateTimeKind.Local).AddTicks(2849),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        });
            ...
            modelBuilder.Entity("JasperGreenTeam02.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 9, 11, 42, 29, 576, DateTimeKind.Local).AddTicks(672)
                        },
                        new
                        {
                            PaymentID = 2,
                            CustomerID = 2,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 9, 11, 42, 29, 579, DateTimeKind.Local).AddTicks(9425)
                        },
                        new
                        {
                            PaymentID = 3,
                            CustomerID = 3,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 9, 11, 42, 29, 579, DateTimeKind.Local).AddTicks(9516)
                        },
                        new
                        {
                            PaymentID = 4,
                            CustomerID = 4,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 9, 11, 42, 29, 579, DateTimeKind.Local).AddTicks(9524)
                        },
                        new
                        {
                            PaymentID = 5,
                            CustomerID = 5,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 9, 11, 42, 29, 579, DateTimeKind.Local).AddTicks(9528)
                        });
                });
