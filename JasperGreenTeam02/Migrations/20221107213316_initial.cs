    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 13, "Dameon", "Walker", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4568), 10.5, "Worker", 123726532 },
                    { 12, "Greg", "Williams", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4565), 10.5, "Worker", 123726532 },
                    { 11, "Spencer", "Simons", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4562), 10.5, "Worker", 123726532 },
                    { 10, "Tyler", "Thames", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4558), 10.5, "Worker", 123726532 },
                    { 9, "Sean", "Price", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4555), 10.5, "Worker", 123726532 },
                    { 8, "Shawn", "Young", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4552), 10.5, "Worker", 123726532 },
                    { 5, "John", "Baptist", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4541), 10.5, "Worker", 123726532 },
                    { 6, "Jimmy", "Neutron", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4545), 10.5, "Worker", 123726532 },
                    { 14, "James", "Thomas", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4571), 10.5, "Worker", 123726532 },
                    { 4, "Josh", "Jacks", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4538), 10.5, "Worker", 123726532 },
                    { 3, "Emmy", "Elders", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4534), 10.5, "Worker", 123726532 },
                    { 2, "Edward", "Linus", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4506), 10.5, "Worker", 123726532 },
                    { 1, "Elliot", "Matterbaby", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(3837), 10.5, "Worker", 123726532 },
                    { 7, "Timmy", "Turner", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4548), 10.5, "Worker", 123726532 },
                    { 15, "Patrick", "Star", new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4575), 10.5, "Worker", 123726532 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 5, 5, 200.0, new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1709) },
                    { 4, 4, 200.0, new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1706) },
                    { 2, 2, 200.0, new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1653) },
                    { 3, 3, 200.0, new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1700) },
                    { 1, 1, 200.0, new DateTime(2022, 11, 7, 15, 33, 15, 805, DateTimeKind.Local).AddTicks(1464) }
                });
