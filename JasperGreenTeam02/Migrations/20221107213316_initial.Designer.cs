...
namespace JasperGreenTeam02.Migrations
{
    ...
    [Migration("20221107213316_initial")]
            ...
            modelBuilder.Entity("JasperGreenTeam02.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(3837),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4506),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4534),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4538),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4541),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4545),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4548),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4552),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4555),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4558),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4562),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4565),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4568),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4571),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        },
                        new
                        {
                            ...
                            HireDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(4575),
                            HourlyRate = 10.5,
                            JobTitle = "Worker",
                            SSN = 123726532
                        });
            ...
            modelBuilder.Entity("JasperGreenTeam02.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 7, 15, 33, 15, 805, DateTimeKind.Local).AddTicks(1464)
                        },
                        new
                        {
                            PaymentID = 2,
                            CustomerID = 2,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1653)
                        },
                        new
                        {
                            PaymentID = 3,
                            CustomerID = 3,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1700)
                        },
                        new
                        {
                            PaymentID = 4,
                            CustomerID = 4,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1706)
                        },
                        new
                        {
                            PaymentID = 5,
                            CustomerID = 5,
                            PaymentAmount = 200.0,
                            PaymentDate = new DateTime(2022, 11, 7, 15, 33, 15, 808, DateTimeKind.Local).AddTicks(1709)
                        });
                });
